			...
			<div class="container">
				...
				<div class="courses-area">
			            <div class="container-fluid">
			                <div id="1" class="row">@foreach($offres as $offre)
			                    <div style="margin-bottom: 20px;" class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
			                        <div class="courses-inner res-mg-b-30">
			                            <div class="courses-title">
			                                <a href="#"><img style="height: 150px;width: 200px;" src="{{url('uploads/'.$offre->filename)}}" alt=""></a>
			                                <h2>{{$offre->nom}}</h2>
			                            </div>
			                            ...
			                            <div class="course-des">
			                                <p><span><i class="fa fa-clock"></i></span> <b>Departement:</b> {{$offre->departement}}</p>
			                                <p><span><i class="fa fa-clock"></i></span> <b>Professor:</b> Jane Doe</p>
			                                <p><span><i class="fa fa-clock"></i></span> <b>Students:</b> 100+</p>
			                            </div>
			                            <div class="product-buttons">
			                                <a href="{{action('OptimaController@show', $offre['id'])}}"><button type="button" class="button-default cart-btn">Read More</button></a>
			                            </div>
			                        </div>
			                    </div>@endforeach
							</div>
