					...
					<div class="row"> 
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="skill-text">
								<h2>À propos :</h2>
								<p>Optima-Tech est une entreprise spécialisée dans le développement informatique . Elle fournit un centre de services de niveau international pour accompagner les éditeurs de logiciels, les sociétés de services (SSII), les directions de système d’information (DSI) ou encore les startups innovatrices dans la mise en œuvre de leurs projets informatiques les plus ambitieux.  </p>
								<p>Optima-Tech a évolué du modèle classique des sociétés de services (délégation de personnel) à un centre d’expertise dans l’ingénierie informatique :</p>
								<p> Conseil en architectures logicielles avancées Mise en œuvre de progiciels, de systèmes d’informations et d’applications web et mobiles </p>
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<div class="single-skill">
								...
								<div class="progress">
									...
									<span class="percent">99%</span></div>
								</div>
							</div>
							<!--/ End Single Skill -->
							<!-- Single Skill -->
							<div class="single-skill">
								...
								<div class="progress">
									...
									<span class="percent">95%</span></div>
								</div>
							</div>
							<!--/ End Single Skill -->
							<!-- Single Skill -->
